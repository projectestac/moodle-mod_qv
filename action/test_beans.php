...
function setRequest(){
  ...
  switch($('bean').value){
    case 'get_sections': request+='<bean id="get_sections" >\n  <param name="assignmentid" value="1" />\n</bean>';break;
...
<INPUT type="text" name="service" id="service" value="/agora/moodle2/mod/qv/action/beans.php" size="100"/>
</li>
<li>
<div class="title">Bean:</div> 
<SELECT name="bean" id="bean" onchange="setRequest();">
  <OPTION value="none"></OPTION>
  <OPTION value="get_sections">get_sections</OPTION>
</SELECT>
</li>
<li>
